...
const i18n = {
  en: {
    ...
    aboutLabel: "About",
    aboutTitle: "Who I Am",
    aboutBio: "IT professional and full-stack web developer based in New York. Currently pursuing a B.S. in Cybersecurity & Information Assurance at Western Governors University. I build real websites for real businesses — from inventory management systems to restaurant sites — and deploy them on my own infrastructure using Cloudflare tunnels and home servers.",
  ...
  es: {
    ...
    aboutBio: "Profesional de TI y desarrollador web full-stack en Nueva York. Actualmente cursando una licenciatura en Ciberseguridad y Aseguramiento de la Informacion en Western Governors University. Construyo sitios web reales para negocios reales — desde sistemas de inventario hasta sitios de restaurantes — y los despliego en mi propia infraestructura usando tuneles Cloudflare y servidores caseros.",
